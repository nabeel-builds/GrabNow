<div align="center">
  <img src="https://cdn-icons-png.flaticon.com/512/3514/3514491.png" alt="GrabNow Logo" width="80" />
  <h1>GrabNow - Full-Stack MERN E-Commerce App</h1>
...
MONGO_URI=mongodb://127.0.0.1:27017/GrabNow
JWT_SECRET=super_secret_key
```

From the **root folder** `GrabNow/`, trigger a full install across environments:
```bash
npm run build
```
...
npm run seed
```
> **Seed Admin Access:** Email: `admin@GrabNow.com` | Password: `password123`
